...
<header class="site-header" id="navbar">
  ...
  <div class="header-util-row">
    <div class="header-util-inner">
      <a href="policies/FSK Child Protection Policy.pdf" target="_blank" class="util-policy">Child Protection Policy</a>
      <div class="util-right">
        <a href="https://www.facebook.com/fountainheadschools" target="_blank" aria-label="Facebook" class="util-social"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg></a>
        <a href="https://instagram.com/fountainheadschools" target="_blank" aria-label="Instagram" class="util-social"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="5"/><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor" stroke="none"/></svg></a>
        <a href="https://www.youtube.com/@fountainheadschools" target="_blank" aria-label="YouTube" class="util-social"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" fill="white"/></svg></a>
        <a href="https://linkedin.com/company/fountainheadschools" target="_blank" aria-label="LinkedIn" class="util-social"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></a>
        <span class="util-sep">|</span>
        <a href="tel:+91${phone1.replace(/[^0-9]/g,'')}" class="util-contact">${escHtml(phone1)}</a>
        <a href="mailto:${escAttr(email)}" class="util-contact">${escHtml(email)}</a>
      </div>
    </div>
  </div>
  <!-- MAIN NAV ROW -->
  <div class="header-row">
    ...
    <nav class="nav-desktop" aria-label="Primary">
      ...
      <div class="nav-group">
        <button class="nav-btn">About Us <span class="nav-arrow"></span></button>
        <div class="nav-mega">
          <div class="nav-mega-inner">
            <div class="nav-mega-tagline">To Nurture Leaders with Character &amp; Competence</div>
      ...
      <div class="nav-group">
        <button class="nav-btn">Our Schools <span class="nav-arrow"></span></button>
        <div class="nav-mega">
          <div class="nav-mega-inner">
            <div class="nav-mega-tagline">Six Campuses · Three Cities · One Vision</div>
            <div class="nav-mega-links">
              <a href="#campuses">All Campuses</a>
              <a href="fsk/index.html">Fountainhead School Kunkni — Surat</a>
              <a href="fsm/index.html">Fountainhead School Malgama — Surat</a>
              <a href="fwgs/index.html">Fountainhead Wockhardt Global School — Chh. Sambhajinagar</a>
              <a href="falh/index.html">Fountainhead Avadh Learning Hub — Vapi</a>
              <a href="fpa/index.html">Fountainhead Preschool Adajan — Surat</a>
              <a href="fpv/index.html">Fountainhead Preschool Vesu — Surat</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="nav-group">
        <button class="nav-btn">Academics <span class="nav-arrow"></span></button>
        <div class="nav-mega">
          <div class="nav-mega-inner">
            <div class="nav-mega-tagline">Full IB Continuum — EY to Diploma</div>
            <div class="nav-mega-links">
      ...
      <a href="#admissions-steps" class="nav-link">Admissions</a>
      <a href="#news" class="nav-link">News</a>
      <a href="#accolades" class="nav-link">Accolades</a>

      <div class="nav-group">
        <button class="nav-btn">Testimonials <span class="nav-arrow"></span></button>
        <div class="nav-mega">
          <div class="nav-mega-inner">
            <div class="nav-mega-tagline">Voices from Our Community</div>
            <div class="nav-mega-links">
      ...
      <div class="nav-group">
        <button class="nav-btn">Connect <span class="nav-arrow"></span></button>
        <div class="nav-mega">
          <div class="nav-mega-inner">
            <div class="nav-mega-tagline">We&apos;d Love to Hear from You</div>
            <div class="nav-mega-links">
...
<section class="campuses-section" id="campuses">
  <div class="container-wide">
    ...
    <div class="campuses-grid-ois">
      ...
      <!-- FWGS — logo on branded dark bg (no building photo available) -->
      <div class="campus-ois" onclick="window.open('fwgs/index.html','_blank')" style="background:linear-gradient(135deg,#002747 0%,#003d7a 50%,#005BAA 100%);display:flex;align-items:center;justify-content:center;">
        <img src="images/fwgs-campus-ref.png" alt="Fountainhead Wockhardt Global School" style="object-fit:contain;padding:32px;opacity:0.92;position:relative;z-index:1;">
        <div class="campus-ois-overlay" style="background:linear-gradient(to top,rgba(0,0,0,0.88) 0%,rgba(0,20,60,0.45) 60%);">
      ...
      <!-- FALH — logo on branded dark bg (no building photo available) -->
      <div class="campus-ois" onclick="window.open('falh/index.html','_blank')" style="background:linear-gradient(135deg,#0a1628 0%,#003d7a 100%);display:flex;align-items:center;justify-content:center;">
        <img src="falh/images/FALH Logo - Colour - JPEG.jpg" alt="Fountainhead Avadh Learning Hub" style="object-fit:contain;padding:32px;opacity:0.9;position:relative;z-index:1;">
        <div class="campus-ois-overlay" style="background:linear-gradient(to top,rgba(0,0,0,0.88) 0%,rgba(0,0,0,0.3) 60%);">
